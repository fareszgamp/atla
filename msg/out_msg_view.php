				...
				<?php if (isset($roomContent)) : ?>
					<?php foreach ($roomContent as $bemutato) : ?>
						<li>
							<div class="fo">
								<div class="info">
									<h4><?php print 'Címzett-'.$bemutato['cimzett']; echo '('.date("m/d H:i",$bemutato['send_date']).')';?></h4>
									<p class="kisbetu"><?php echo clean($bemutato['uzenet']); ?></p>
									<p class="kisbetu">
										Küldte: <?php echo $bemutato['kuldo']; ?>
									</p>
								</div>
							</div>
